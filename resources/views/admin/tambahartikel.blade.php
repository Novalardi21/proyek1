...
@section('title', $title ?? 'Tambah Artikel')

@section('content')
    <div class="container mt-3">
        <div class="card shadow-sm" style="border-radius: 12px; border: 3px solid orange;">
            <div class="card-body p-4">
                <h3 class="mb-4 text-center fw-bold">Tambah Artikel</h3>
                ...
                <form action="{{ route('admin.artikel.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="gambar" class="form-label fw-semibold">Gambar Artikel</label>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="konten" id="konten" rows="8" class="form-control @error('konten') is-invalid @enderror"
                            placeholder="Tulis isi artikel...">{{ old('konten') }}</textarea>
                        @error('konten')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
